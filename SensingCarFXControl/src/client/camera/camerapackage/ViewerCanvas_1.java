package client.camera.camerapackage;
 ...
 * @author blueskii
 */
public class ViewerCanvas_1 extends Canvas implements  ImageChangeListener, Runnable {
    ...
    public ViewerCanvas_1() {}
    public ViewerCanvas_1(double width, double height) {
        super(width, height);
    }
